...
function parseDailyTraining(playerID, playerContainerHTML) {
  ...
  //If rested, no progress image is displayed at all. So we cant parse progress, skill, ballGained,
  //boost, currentLevel
  //if (progressImg === restedText) {
  //trainingReport.rested = true;
  //} else {
  ////This only exists if some progress is made...
  //trainingReport.currentLevel = parseSkillLevel(playerContainerHTML, trainingReport.skill);
